        ...
        <main v-else class="page-roulette">
            <div class="sidebar">
                <p class="type-label-md" style="color: #aaa">
                    Credits to <a href="https://matcool.github.io/extreme-demon-roulette/" target="_blank">matcool</a>.
                </p>
                <form class="options">
                    <div class="check">
                    ...
                    <div class="check">
                        ...
                        <label for="extended">Extended List 
                        (There is no Extended List yet)</label>
                    </div>
